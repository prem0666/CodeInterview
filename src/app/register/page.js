    ...
    <div className="min-h-screen bg-[#0a0e1a] text-slate-100 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#131929] border border-indigo-500/20 rounded-2xl p-8">
          ...
          <p className="text-slate-400 text-sm mb-8">Start your interview prep journey today — free forever</p>
          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className={`h-1 flex-1 rounded-full transition-all ${
                    form.password.length >= i * 2
                      ? i <= 2 ? "bg-red-500" : i === 3 ? "bg-yellow-400" : "bg-green-400"
                      : "bg-slate-700"
                  }`} />
                ))}
              </div>
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-indigo-600 text-white font-semibold text-sm shadow-[0_0_20px_rgba(99,102,241,0.35)] hover:bg-indigo-500 transition"
            >
